...
const I18N = {
  en: {
    ...
    scheduleTag:'NEXT PATROL',
    scheduleTitle:'UPCOMING STREAM',
    scheduleStarts:'Starts in',
    scheduleDays:'days',
    scheduleHours:'hours',
    scheduleMinutes:'minutes',
    scheduleSoon:'Starting soon',
    scheduleCta:'Open Kick',
    scheduleFlexibleTitle:'NIGHT PATROLS',
    scheduleFlexibleSub:'Abu Adamz usually goes live at night, with no fixed schedule. Follow Kick or the community alerts so you catch the next patrol.',
    scheduleFlexibleBadge:'Usually live at night',
    clipsTag:'FIELD REPORTS',
    clipsTitle:'CLIPS & HIGHLIGHTS',
    clipsSub:'Highlights from recent patrols and streams.',
  ...
  ar: {
    ...
    scheduleTag:'الباترول الجاي',
    scheduleTitle:'البث القادم',
    scheduleStarts:'هيبدأ خلال',
    scheduleDays:'يوم',
    scheduleHours:'ساعة',
    scheduleMinutes:'دقيقة',
    scheduleSoon:'هيبدأ قريب',
    scheduleCta:'افتح Kick',
    scheduleFlexibleTitle:'باترولات الليل',
    scheduleFlexibleSub:'أبو آدم غالبًا بيبدأ بثه بالليل من غير جدول ثابت. تابِعه على Kick أو تنبيهات العيلة علشان تلحق الباترول الجاي.',
    scheduleFlexibleBadge:'غالبًا لايف بالليل',
    clipsTag:'تقارير الميدان',
    clipsTitle:'الكليبات والهايلايتس',
    clipsSub:'أقوى اللقطات من الباترولات والبثوث الأخيرة.',
