...
const I18N = {
  en: {
    ...
    shareText:'ABU ADAMZ · Streamer and Police RP Commander',
    clipsTag:'FIELD REPORTS',
    clipsTitle:'CLIPS & HIGHLIGHTS',
    clipsSub:'The most-watched Kick moments and Abu Adamz latest TikTok videos, refreshed automatically.',
    clipsKickTitle:'KICK · MOST VIEWED',
    clipsKickSub:'Ranked by views. Keep scrolling to load every available clip.',
    clipsTikTokTitle:'LATEST ON TIKTOK',
    clipsTikTokSub:'Recent videos from the official profile. Swipe or scroll sideways to explore.',
    clipsAuto:'Auto-updated',
    clipsLoading:'Loading the top clips...',
    clipsError:'The clips could not sync right now.',
    clipsRetry:'Try again',
    clipsPrevious:'Previous clips',
    clipsNext:'Next clips',
    clipsAllKick:'Open all clips on Kick',
    clipViews:'views',
    clipWatch:'Watch clip',
  ...
  ar: {
    ...
    shareCopied:'الرابط اتنسخ',
    shareText:'أبو آدمز · ستريمر وقائد شرطة رول بلاي',
    clipsTag:'تقارير الميدان',
    clipsTitle:'الكليبات والهايلايتس',
    clipsSub:'أعلى لحظات Kick مشاهدة وآخر فيديوهات أبو آدم على TikTok، بتتحدث أوتوماتيك.',
    clipsKickTitle:'KICK · الأعلى مشاهدة',
    clipsKickSub:'مرتبة بعدد المشاهدات. كمّل سكرول علشان باقي الكليبات تتحمّل.',
    clipsTikTokTitle:'أحدث فيديوهات TIKTOK',
    clipsTikTokSub:'آخر فيديوهات الحساب الرسمي. اسحب أو اعمل سكرول يمين وشمال براحتك.',
    clipsAuto:'تحديث أوتوماتيك',
    clipsLoading:'بنحمّل أقوى الكليبات...',
    clipsError:'مقدرناش نزامن الكليبات دلوقتي.',
    clipsRetry:'حاول تاني',
    clipsPrevious:'الكليبات اللي قبلها',
    clipsNext:'الكليبات اللي بعدها',
    clipsAllKick:'افتح كل الكليبات على Kick',
    clipViews:'مشاهدة',
    clipWatch:'شوف الكليب',
